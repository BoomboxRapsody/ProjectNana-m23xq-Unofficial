...
EXTRACT_SUPER "$FIRM_STOCK_DIR/$STOCK_DEVICE"
EXTRACT_FIRMWARE "$FIRM_STOCK_DIR/$STOCK_DEVICE" "all"
EXTRACT_SUPER "$FIRM_TARGET_DIR/$TARGET_DEVICE"
EXTRACT_FIRMWARE "$FIRM_TARGET_DIR/$TARGET_DEVICE" "all"

DECODE_OMC "$FIRM_STOCK_DIR/$STOCK_DEVICE" "$WORK_DIR"
DECODE_OMC "$FIRM_TARGET_DIR/$TARGET_DEVICE" "$WORK_DIR"
